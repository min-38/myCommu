...
public class DataRestTest {
    ...
    @Test
    void givenNothing_whenRequestArticles_thenReturnsArticlesJson() throws Exception {
        // Given
    ...
    @DisplayName("[api] 게시글 싱글 조회")
    @Test
    void givenNothing_whenRequestArticle_thenReturnsArticleJson() throws Exception {
        // Given
